...
class eha_multi_carrier_shipping_method extends WC_Shipping_Method {
        ...
        function generate_premium_ad_html()
        {
                ob_start();	
				...
				'default'         => '',
                    ...
                    'is_recipient_address_residential'              => array(
                      ...
                      'empty_responce_shipping_cost_on'           => array(
                                ...
                                'type'            => 'select',
                                'default'         => 'per_unit_quantity',
                                'description'     => __( 'This Cost will be added for every unit of product if no rule is applied on it', 'eha_multi_carrier_shipping' ),
                           'options'         => array('per_unit_quantity'       => __( 'Per Unit Quantity', 'eha_multi_carrier_shipping' ),
                                ...
                                <table class="multi_carrier_shipping_boxes widefat" style="background-color:#f6f6f6;">
                                        ...
                                        <tfoot>
                                                <tr>
                                                        ...
                                                        <th colspan="6">
                                                                <small class="description" style="float:right;margin-right: 5px;">
    ...
    <?php } ?>                                                                                                                            
                                        ...
                                        if ( $this->rate_matrix ) {
                                                foreach ( $this->rate_matrix as $key => $box ) {
                                                        ...
                                                        <select id="area_list_combo_<?php echo $key;?>" class="<?php echo $this->drop_down_style;?> enabled" data-identifier="area_list_combo" style="" name='rate_matrix[<?php echo $key;?>][area_list][]'>
                                                                        <?php 
                                                        ...
                                                        <option value="item" <?php selected(isset($box['cost_based_on']) ? $box['cost_based_on'] : '','item');?>>Item Qty</option></select></td>
                                ...
                                <script type="text/javascript">																	
                                        jQuery(window).load(function(){
                                                ...
                                                jQuery('.multi_carrier_shipping_boxes .insert').click( function() {
                                                        ...
                                                        <td class="<?php echo $this->wf_hidden_matrix_column('area_list');?>" style="overflow:visible">\
                                                                <select id="area_list_combo_'+size+'" class="<?php echo $this->drop_down_style;?> enabled" data-identifier="area_list_combo" style="" name="rate_matrix['+size+'][area_list][]">\
                                                                        <?php 
                                                                        $area_list = $this->wf_get_area_list();
                                                        ...
                                                        <td class="<?php echo $this->wf_hidden_matrix_column('cost_based_on');?>"><select id="cost_based_on_'+size+'" class="select singleselect" data-identifier="cost_based_on" name="rate_matrix['+size+'][cost_based_on]"><option value="item">Item Qty</option></select></td> \
        ...
        function calculate_shipping( $package = array() ) 
                {     
                    ...
                    if( empty($this->settings['emailid']) )
                        {
                            $this->debug( '<div style="background:red;color:white"> Warning: Multi Carrier Shipping Plugin:  Please Enter API Email id  in (Woocommerce>Settings>Shipping>Multi_Carrier_Shipping Page) </div>');
                            return;
                        }
                    elseif(strlen($this->settings['apikey'])===0)
                           {                               
